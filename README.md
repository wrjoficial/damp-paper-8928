...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/damp-paper-8928)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/damp-paper-8928
```

A live public deployment of this template is available at [https://damp-paper-8928.templates.workers.dev](https://damp-paper-8928.templates.workers.dev)
